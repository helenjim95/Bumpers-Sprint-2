...
public class AudioPlayer implements AudioPlayerInterface {
	...
	private static final String CRASH_SOUND_FILE = "Bang3.wav";
	 ...
	 */
	public AudioPlayer() {
		this.musicPlayer = new MediaPlayer(loadAudioFile(getBackgroundMusicFile()));
		this.crashPlayer = new AudioClip(convertNameToUrl(getCrashSoundFile()));
	}
